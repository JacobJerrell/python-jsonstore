...
class JsonStore(object):
    ...
    def __get_obj(self, steps):
        ...
        for step in steps:
            ...
            try:
                ...
                raise KeyError("unable to get %s from %s: %s" % (step, path, e))
            except IndexError as e:
                raise IndexError("unable to get %s from %s: %s" % (step, path, e))
            except TypeError as e:
                raise TypeError("unable to get %s from %s: %s" % (step, path, e))
            path.append(step)
        return obj
    ...
    def __setitem__(self, key, value):
        ...
        try:
            ...
            raise IndexError("unable to set %s from %s: %s" % (step, path, e))
        except TypeError as e:
            raise TypeError("unable to set %s from %s: %s" % (step, path, e))
        self._do_auto_commit()
    ...
    def __delitem__(self, key):
        ...
        try:
            ...
            raise KeyError("unable to delete %s from %s: %s" % (step, path, e))
        except IndexError as e:
            raise IndexError("unable to delete %s from %s: %s" % (step, path, e))
        except TypeError as e:
            raise TypeError("unable to delete %s from %s: %s" % (step, path, e))
